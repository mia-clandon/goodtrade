...
<ul class="categories-list">
    ...
    ?>
        <li data-category-id="<?= $category['id']; ?>" class="categories-list__category-item <?= $category['has_child'] ? 'categories-list__category-item_parent' : '';?>">
            <a data-category-id="<?= $category['id']; ?>" class="categories-list__category-item-link" href="<?= Yii::$app->urlManager->createUrl(['/category/update', 'id' => $category['id']]);?>">
                <?= $category['title']; ?>
            </a>
            <div class="categories-list__category-item-actions">
                ...
                <a
                    ...
                    class="categories-list__category-item-action-link remove"
                ...
                <? foreach ($vocabularies as $vocabulary) { ?>
                    <span>
                        <a href="#"
                           ...
                           class="update-vocabulary categories-list__specification-item">
                            <?= $vocabulary->title; ?>
                        </a>
            ...
            <?
                // тут могут быть вложенные категории.
                echo (new CatalogProcessor())
