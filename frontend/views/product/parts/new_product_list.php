<?
/**
 * Элемент/ы товара. (новая вёрстка.)
                ...
                <div class="elements-grid__cell-content">
                    ...
                    <div class="elements-grid__cell-bottom-container">
                        ...
                        <div class="elements-grid__cell-price-container">
                            <div class="elements-grid__cell-price"><?= $product->getFormattedPrice(' '); ?> тг.</div>
        ...
        <div class="elements-grid__cell-footer-container">
            ...
            <div class="elements-grid__cell-footer">
                <span class="modal-wrapper" data-type="popup-wrapper">
                    <button data-id="<?= $product->id; ?>" data-version="new" data-action="popup-toggle" class="button button_small button_primary popup-toggle">
                ...
                <button data-id="<?= $product->id; ?>" data-key="compare<?=\Yii::$app->user->id?>" class="button button_small button_link button_action js-keeper">
                    <span class="button__icon button__icon_left button__icon_scales-plus"></span>
                </button>
                <button data-id="<?= $product->id; ?>" data-key="favorite_product<?=\Yii::$app->user->id?>" class="button button_small button_link button_action js-keeper">
        ...
        <div class="elements-grid__cell-content">
            ...
            <div class="breadcrumbs">
                <div class="breadcrumbs__item breadcrumbs__item_white">
                    <a href="<?=$activity_url;?>" class="breadcrumbs__item-icon breadcrumbs__item-icon_<?=$activity->icon_class;?>-white"></a>
                </div>
                <div class="breadcrumbs__item breadcrumbs__item_white">
            ...
            <div class="elements-grid__cell-bottom-container">
                <div class="row">
                    <div class="col col_two-thirds">
                        <a href="<?= Yii::$app->urlManager->createUrl(['product/show', 'id' => $product->id]); ?>" class="elements-grid__cell-title" title="<?= $product->getTitle(); ?>">
                            <?= $product->getTitle(); ?>
                        </a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg col-lg_two-thirds">
                        <? if (!$product->isPriceWitVAT()) { ?>
                            <div class="elements-grid__cell-vat elements-grid__cell-vat_white">Цена без НДС</div>
                        <? } ?>
                        <div class="elements-grid__cell-price-container">
                            <div class="elements-grid__cell-price elements-grid__cell-price_white"><?= $product->getFormattedPrice(' '); ?> тг.</div>
