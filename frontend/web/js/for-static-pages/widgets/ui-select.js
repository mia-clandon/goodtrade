//TODO: Сделать фокусировку в конец и data-editable

define('widgets/ui-select', ['jquery', 'jquery-ui'], function ($) {
    /**
     * Виджет Select
     ...
     */
    $.widget('ui.select', [$.ui.formResetMixin, {
        version: '1.0.0',
        options: {
            isActive: false,
            isEditable: false
        ...
        _init: function () {
            var paramName = this.selectElem.attr('name');
        ...
        /**
         * Обратботчик клика по элементу из списка
         * @param event
         * @private
         */
