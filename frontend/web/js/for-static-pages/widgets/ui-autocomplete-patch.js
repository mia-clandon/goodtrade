define('widgets/ui-autocomplete-patch', ['jquery', 'jquery-ui', 'widgets/ui-animation-mixin'], function ($) {

    $.widget('ui.autocomplete', $.ui.autocomplete, [$.ui.animationMixin, {
        options: {
            minLength: 3,
            popupOnFocus: true,
            position: {
...
//
        ...
        _renderItemData: function (ul, item) {
            var $item = this._renderItem(ul, item).data("ui-autocomplete-item", item);
